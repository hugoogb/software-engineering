...
int main()
{
  int dificultat, operacio, min = 0, max, puntuacio = 0, coeficient, totalPuntuacio = 0, respostes = 0;
  ...
  cout << "2 - Mig" << endl;
  cout << "3 - Dificil" << endl;
  cout << "Benvingut al Brain Training Game! Si us plau, selecciona una dificultat: "; cin >> dificultat;

  while (dificultat != FACIL && dificultat != MIG && dificultat != DIFICIL) {
    cout << "Seleccio incorrecta. Si us plau, selecciona una dificultat: "; cin >> dificultat;
  }
  ...
  do {
    ...
    if (operacio == SUMA) {
      cout << operand1 << " + " << operand2 << " = "; cin >> resUsuari;
      ...
      cout << operand1 << " x " << operand2 << " = "; cin >> resUsuari;
      resOperacio = operand1 * operand2;
      encert = (resOperacio == resUsuari);
  ...
  cout << "Has aconseguit encadenar " << respostes << " respostes correctes amb una puntuacio final de: " << totalPuntuacio << " punts." << endl;
